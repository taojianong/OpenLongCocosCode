...
<div class="panel">
  ...
  <div class="content">
    ...
    ready() {
        ...
        // 启用/禁用对齐线
        this.$enableGuides.addEventListener('change', (e) => {
            sendToMain('set-guides-enabled', e.target.checked);
        });
        // 对齐线颜色
        this.$guideColor.addEventListener('change', (e) => {
            sendToMain('set-guide-color', e.target.value);
        });
        // 对齐线透明度
        this.$guideOpacity.addEventListener('input', (e) => {
        ...
        // 设计图导入
        this.$designImage.addEventListener('change', (e) => {
        ...
        // 设计图透明度
        this.$designOpacity.addEventListener('input', (e) => {
            const value = e.target.value;
        ...
        // 对齐线样式
        this.$guideStyle.addEventListener('change', (e) => {
    ...
    renderGuidesList() {
        ...
        this._guides.forEach((guide, index) => {
            var _a;
            ...
            (_a = item.querySelector('.delete-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
                sendToMain('remove-guide', index);
    ...
    messages: {
        'update-guides-list'(event, guidesData) {
            ...
            if (Array.isArray(guidesData)) {
                ...
                try {
                    this._guides = JSON.parse(guidesData);
                }
                catch (e) {
                    this._guides = [];
                }
